...
export default function Create({ suppliers, products }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("stock-management.store"), {
            onSuccess: () => toast.success("Transaksi stok berhasil dibuat"),
            onError: () => toast.error("Gagal menyimpan transaksi stok"),
        });
    };

    return (
        <>
            <Head title="Tambah Transaksi Stok" />
